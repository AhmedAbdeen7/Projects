...
player::player(int** temp) {
    QPixmap playerImage("C:/Users/Power/Desktop/PacmanGame-master/Assets/pacmanR.png");
...
void player::move()
{
    ...
    if( (col == TotalColumns-2) && (row == 14) && (tempDirect == 'R')){
      ...
      } else if (tempDirect=='R' && (col+1==TotalColumns||boardData[row][col+1]>0) ){
          Xpos += speed;
...
if(tempDirect == 'R'){
    if(boardData[row][col+1]>0){
        if(frame%6==0)
            pacman.load("C:/Users/Power/Desktop/PacmanGame-master/Assets/pacmanClosed.png");
        if(frame%6==1)
            pacman.load("C:/Users/Power/Desktop/PacmanGame-master/Assets/pacmanR1.png");
        if(frame%6==2)
            pacman.load("C:/Users/Power/Desktop/PacmanGame-master/Assets/pacmanR2.png");
        if(frame%6==3)
            pacman.load("C:/Users/Power/Desktop/PacmanGame-master/Assets/pacmanR.png");
        if(frame%6==4)
            pacman.load("C:/Users/Power/Desktop/PacmanGame-master/Assets/pacmanR2.png");
...
if(tempDirect == 'L'){
    if((boardData[row][col-1]>0) || (Xpos != blockDim*(col)+margin)){ //keep animating till the image xpos reaches the edge
        if(frame%6==0)
            pacman.load("C:/Users/Power/Desktop/PacmanGame-master/Assets/pacmanClosed.png");
        if(frame%6==1)
            pacman.load("C:/Users/Power/Desktop/PacmanGame-master/Assets/pacmanL1.png");
        if(frame%6==2)
            pacman.load("C:/Users/Power/Desktop/PacmanGame-master/Assets/pacmanL2.png");
        if(frame%6==3)
            pacman.load("C:/Users/Power/Desktop/PacmanGame-master/Assets/pacmanL.png");
        if(frame%6==4)
            pacman.load("C:/Users/Power/Desktop/PacmanGame-master/Assets/pacmanL2.png");
        if(frame%6==5)
            pacman.load("C:/Users/Power/Desktop/PacmanGame-master/Assets/pacmanL1.png");
...
if(tempDirect == 'U'){
    if((boardData[row-1][col]>0) || (Ypos != blockDim*(row)+margin)){
        if(frame%6==0)
            pacman.load("C:/Users/Power/Desktop/PacmanGame-master/Assets/pacmanClosed.png");
        if(frame%6==1)
            pacman.load("C:/Users/Power/Desktop/PacmanGame-master/Assets/pacmanU1.png");
        if(frame%6==2)
            pacman.load("C:/Users/Power/Desktop/PacmanGame-master/Assets/pacmanU2.png");
        if(frame%6==3)
            pacman.load("C:/Users/Power/Desktop/PacmanGame-master/Assets/pacmanU.png");
        if(frame%6==4)
            pacman.load("C:/Users/Power/Desktop/PacmanGame-master/Assets/pacmanU2.png");
        if(frame%6==5)
            pacman.load("C:/Users/Power/Desktop/PacmanGame-master/Assets/pacmanU1.png");
...
if(tempDirect == 'D'){
    if(boardData[row+1][col]>0){
        if(frame%6==0)
            pacman.load("C:/Users/Power/Desktop/PacmanGame-master/Assets/pacmanClosed.png");
        if(frame%6==1)
            pacman.load("C:/Users/Power/Desktop/PacmanGame-master/Assets/pacmanD1.png");
        if(frame%6==2)
            pacman.load("C:/Users/Power/Desktop/PacmanGame-master/Assets/pacmanD2.png");
        if(frame%6==3)
            pacman.load("C:/Users/Power/Desktop/PacmanGame-master/Assets/pacmanD.png");
        if(frame%6==4)
            pacman.load("C:/Users/Power/Desktop/PacmanGame-master/Assets/pacmanD2.png");
        if(frame%6==5)
            pacman.load("C:/Users/Power/Desktop/PacmanGame-master/Assets/pacmanD1.png");
