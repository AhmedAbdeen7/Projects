...
class BaCardSupermarkets extends StatelessWidget {
  const BaCardSupermarkets({super.key});
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Vendor cards in a responsive layout
                  Row(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      // First column - The Grocer
                      Expanded(
                        child: _buildVendorCard(
                          context,
                          baseSize,
                          "assets/images/ba_card/TheGrocer.png",
                          "The Grocer",
                          [
                            "Garden 8, First Settlement",
                            "Zamalek",
                            "Maadi",
                            "Marassi, North Coast",
                          ],
                      ...
                      Expanded(
                        child: _buildVendorCard(
                          context,
                          baseSize,
                          "assets/images/ba_card/7mart.png",
                          "7Mart",
                          [
                            "Concord Plaza (Supermarket)",
                            "Arabella Plaza",
                            "Mivida",
                            "West Mark",
                            "Hyde Park (Supermarket)",
                            "Marassi",
                            "Azha, Ain Sokhna",
                          ],
                          "10%",
                  ...
                  // Mahmoud El Far - Full width card
                  _buildVendorCard(
                    context,
                    baseSize,
                    "assets/images/ba_card/Elfar.png",
                    "MahmoudElFar",
                    [
                      "Mohandessin",
                      "Masr ElGedida",
                      "Sheikh Zayed Madinaty",
                      "5th Settlement",
                      "Mivida",
                      "Port Said",
                    ],
